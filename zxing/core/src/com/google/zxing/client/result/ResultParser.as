...
public class ResultParser {
  ...
  public static function parseResult(theResult:Result):ParsedResult {
	...
	var utf8Str:String;
	if (theResult.getBytes()) {
		var raw:ByteArray = theResult.getBytes();
		raw.position = 0;
		utf8Str = (raw.readMultiByte(raw.length, "utf-8"));
		//utf8Str = (raw.readMultiByte(raw.length, "gb2312"));
	} else {
		utf8Str = theResult.getText();
	}
	//<<-------------------- 中文乱码解决 ----------------------gujj@2012/08/12 add
	
    return new TextParsedResult(utf8Str, null);
  }
